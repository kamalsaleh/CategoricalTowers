...
category_constructor := data_tables -> AdelmanCategory( AdditiveClosure( AlgebroidFromDataTables( ShallowCopy( data_tables ) : FinalizeCategory := true ) : FinalizeCategory := true ) );;
...
compiled_category_name := "AdelmanCategoryOfAdditiveClosureOfAlgebroidFromDataTablesPrecompiled";;
...
A := AdelmanCategoryOfAdditiveClosureOfAlgebroidFromDataTablesPrecompiled( given_arguments[1] );
