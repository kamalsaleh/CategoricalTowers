...
##
InstallGlobalFunction( PathCategory,
  ...
  function ( q )
    ...
    if admissible_order in [ fail, "ll-lex", "Dp" ] then
        
        admissible_order := "Dp";
        
    elif admissible_order in [ "rl-lex", "dp" ] then
        
        admissible_order := "dp";
        
    else
        
        Error( "the passed admissible_order is unknown!\n" );
      ...
      function ( C, mor_1, mor_2 )
        ...
        return IsEqualForObjects( C, Source( mor_1 ), Source( mor_2 ) )
                  and IsEqualForObjects( C, Target( mor_1 ), Target( mor_2 ) )
                    and MorphismDatum( mor_1 ) = MorphismDatum( mor_2 );
    ...
    AddPreCompose( C,
      ...
      function ( C, mor_1, mor_2 )
        ...
        return MorphismConstructor( C,
                      Source( mor_1 ),
                      Pair( MorphismLength( mor_1 ) + MorphismLength( mor_2 ), Concatenation( MorphismSupport( mor_1 ), MorphismSupport( mor_2 ) ) ),
                      Target( mor_2 ) );
        
    end );
    
    ## Random Methods, maybe they can be optimized!
    ##
...
InstallOtherMethod( ExternalHomsWithGivenLength,
  ...
  function ( C, l, u )
    ...
    return LazyHList( [ 1 .. nr_objs ], s -> LazyHList( [ 1 .. nr_objs ], t -> Concatenation( List( [ l .. u ], len -> ExternalHomsWithGivenLength( C, u + l - len )[s][t] ) ) ) );
...
InstallMethod( SetOfObjects,
  ...
  C -> List( SetOfObjects( CapQuiver( C ) ),
...
InstallMethod( SetOfGeneratingMorphisms,
  ...
  C -> List( SetOfMorphisms( CapQuiver( C ) ),
          mor -> MorphismConstructor( C, SetOfObjects( C )[ObjectIndex( Source( mor ) )], Pair( 1, [ mor ] ), SetOfObjects( C )[ObjectIndex( Target( mor ) )] ) )
);
...
InstallMethod( LaTeXOutput,
  ...
  obj -> LaTeXOutput( ObjectDatum( obj ) )
);
...
InstallMethod( ObjectLabel,
  ...
  obj -> ObjectLabel( ObjectDatum( obj ) )
);
...
##
InstallOtherMethod( \/,
        [ IsCapQuiverObject, IsPathCategory ],
  
  function ( obj, C )
    
    return ObjectConstructor( C, obj );
...
InstallOtherMethod( \/,
  ...
  function ( mor, C )
    ...
    return MorphismConstructor( C, SetOfObjects( C )[ObjectIndex(Source( mor ))], Pair( 1, [ mor ] ), SetOfObjects( C )[ObjectIndex(Target( mor ))] );
...
InstallOtherMethod( IsDescendingForMorphisms,
  ...
  { mor_1, mor_2 } -> IsAscendingForMorphisms( mor_2, mor_1 )
);
...
InstallOtherMethod( IsDescendingForMorphisms,
  ...
  { C, mor_1, mor_2 } -> IsAscendingForMorphisms( C, mor_2, mor_1 )
);
...
InstallMethod( IsDescendingForMorphisms,
  ...
  { C, mor_1, mor_2, admissible_order } -> IsAscendingForMorphisms( C, mor_2, mor_1, admissible_order )
);
...
InstallOtherMethod( IsAscendingForMorphisms,
  ...
  { mor_1, mor_2 } -> IsAscendingForMorphisms( CapCategory( mor_1 ), mor_1, mor_2 )
);
...
InstallOtherMethod( IsAscendingForMorphisms,
  ...
  { C, mor_1, mor_2 } -> IsAscendingForMorphisms( C, mor_1, mor_2, C!.admissible_order )
);
...
InstallOtherMethod( IsFinitePathCategory,
  ...
  C -> HasFiniteNumberOfNonMultiples( C, [ ] )
);
  ...
  function ( C, monomials )
    ...
    return LazyHList( [ 1 .. nr_objs ],
              s -> LazyHList( [ 1 .. nr_objs ],
                t -> List( supports[s][t],
                  supp -> MorphismConstructor( C, SetOfObjects( C )[s], Length( supp ), supp, SetOfObjects( C )[t] ) ) ) );
