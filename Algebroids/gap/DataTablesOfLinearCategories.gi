...
#= comment for Julia
##
BindGlobal( "DATA_TABLES_OF_CATEGORY_FOR_ALGEBROID_DEFINED_BY_QUIVER_ALGEBRA",
...
InstallMethod( DataTablesOfLinearCategory,
  ...
  function ( kC )
    ...
    #= comment for Julia
    elif IsAlgebroid( kC ) then
        
        return DATA_TABLES_OF_CATEGORY_FOR_ALGEBROID_DEFINED_BY_QUIVER_ALGEBRA( kC );
    # =#
