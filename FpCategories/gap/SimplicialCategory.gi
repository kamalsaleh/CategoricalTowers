  ...
  function( n )
    ...
    if n = 0 then
        ...
        relations := List( [ [ "s*id", "id_C0" ],
                             [ "t*id", "id_C0" ] ], pair -> Pair( CallFuncListAtRuntime( \/, [ pair[1], F ] ), CallFuncListAtRuntime( \/, [ pair[2], F ] ) ) );
        ...
        relations := List( [ [ "s*id", "id_C0" ],
                             ...
                             [ "t*mu", "t*pt" ],
                             [ "mu*is", "id_C1" ],
                             [ "mu*it", "id_C1" ] ], pair -> Pair( CallFuncListAtRuntime( \/, [ pair[1], F ] ), CallFuncListAtRuntime( \/, [ pair[2], F ] ) ) );
