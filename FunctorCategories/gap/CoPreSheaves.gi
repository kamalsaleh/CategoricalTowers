...
InstallMethod( CoPreSheaves,
  ...
  function( CAP_NAMED_ARGUMENTS, B )
    ...
    return CoPreSheaves( B, RangeCategoryOfHomomorphismStructure( B ) : FinalizeCategory := CAP_NAMED_ARGUMENTS.FinalizeCategory, overhead := CAP_NAMED_ARGUMENTS.overhead, no_precompiled_code := CAP_NAMED_ARGUMENTS.no_precompiled_code );
