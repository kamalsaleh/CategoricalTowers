...
#= comment for Julia (clash with other installations on the same filters in FunctorCategories)
  ...
  function( CAP_NAMED_ARGUMENTS, I, D )
    ...
    PSh_I_I :=
      CAP_INTERNAL_CONSTRUCTOR_FOR_TERMINAL_CATEGORY( rec(
              ...
              morphism_constructor := morphism_constructor,
              morphism_datum := morphism_datum,
              range_category_of_homomorphism_structure := H ) : overhead := CAP_NAMED_ARGUMENTS.overhead );
